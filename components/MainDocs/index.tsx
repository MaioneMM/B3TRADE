          ...
          <aside>
            <div>
              ...
              <p>
                ...
                <a
                  href="https://app.swaggerhub.com/apis-docs/Alissonsleal/B3TRADE"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  https://app.swaggerhub.com/apis-docs/Alissonsleal/B3TRADE
                </a>
              </p>
              ...
              <p>
                <strong>
                  ...
                  <Link href="/docs/list" target="_blank" rel="noopener noreferrer">
              ...
              <p>
                ...
                >
                  <code className="code-get">
                    GET https://b3trade.ga/api/quote/COGN3
                  </code>
                </a>
              </p>
              ...
              <p>
                ...
                >
                  <code className="code-get">
                    GET https://b3trade.ga/api/quote/COGN3,MGLU3,VVAR3,OIBR3
                  </code>
                </a>
              </p>
              ...
              <p>
                ...
                >
                  <code className="code-get">
                    GET https://b3trade.ga/api/quote/COGN3?fundamental=true
                  </code>
                </a>
              </p>
              ...
              <p>
                ...
                >
                  <code className="code-get">
                    GET https://b3trade.ga/api/quote/COGN3?interval=1d&range=1mo
                  </code>
                </a>
              </p>
              ...
              <p>
                ...
                >
                  <code className="code-get">
                    GET
                    https://b3trade.ga/api/quote/COGN3,MGLU3,VVAR3,OIBR3?interval=1d&range=1mo
                  </code>
                </a>
              </p>
              <p>
                ...
                >
                  <code className="code-get">
                    GET https://b3trade.ga/api/available?search=CO
                  </code>
                </a>
              </p>
              <p>
                ...
                >
                  <code className="code-get">
                    GET https://b3trade.ga/api/v2/crypto?coin=BTC,ETH&currency=BRL
                  </code>
                </a>
              </p>
              <p>
                ...
                >
                  <code className="code-get">
                    GET https://b3trade.ga/api/v2/crypto/available?search=BT
                  </code>
                </a>
              </p>
            </div>
            ...
            <div>
              <details>
                ...
                <pre>
                  <code>
                    {`
// GET https://b3trade.ga/api/quote/COGN3,MGLU3,VVAR3,OIBR3?interval=1d&range=1mo
            ...
            <div>
              <details>
                ...
                <pre>
                  <code>
                    {`
// GET https://b3trade.ga/api/quote/list?sortBy=volume&sortOrder=desc&limit=5
...
// A lista de criptomoedas aceitas é encontrada em: https://b3trade.ga/api/v2/crypto/available
// A lista de moedas aceitas em "currency" é encontrada em: https://b3trade.ga/api/v2/currency/available
            ...
            <div>
              <details>
                ...
                <pre>
                  <code>
                    {`
// GET https://b3trade.ga/api/v2/currency?currency=USD-BRL,EUR-BRL
// A lista de moedas aceitas é encontrada em: https://b3trade.ga/api/v2/currency/available
            ...
            <div>
              <details>
                ...
                <pre>
                  <code>
                    {`
// GET https://b3trade.ga/api/v2/currency/available?search=BRL
